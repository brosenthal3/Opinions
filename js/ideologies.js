...
class ideology{
    //the constructor
    constructor(xmin, xmax, ymin, ymax, name, description){
...
var ideologyObjects = [
     facism = new ideology(0,14,8,14, "Fascism", "Fascism is a form of government which is a type of one-party dictatorship. Fascists are against democracy. They work for a totalitarian one-party state. This aim is to prepare the nation for armed conflict, and to respond to economic difficulties."),
     ...
     ancap = new ideology(3,14,-14,-6, "Anarcho-Capitalism", "Anarcho-capitalism is a political philosophy and modern school of anarchist thought that advocates the elimination of centralized state domination in favor of self-ownership, private property and free markets."),
     classlib = new ideology(2,14,-6,2, "Classical-Liberalism", "Classical liberalism. Classical liberalism is a political philosophy and ideology belonging to liberalism in which primary emphasis is placed on securing the freedom of the individual by limiting the power of the government."),
     centre_right = new ideology(0,2,-6,8, "Centre-Right", "Centre-right politics, also referred to as moderate-right politics, are politics that lean to the right of the left-right political spectrum, but are closer to the centre than other right-wing variants. From the 1780s to the 1880s, there was a shift in the Western world of social class structure and the economy, moving away from the nobility and mercantilism, and moving towards the bourgeoisie and capitalism. "),
     marxism = new ideology(-14,0,8,14, "Communism", "Communism is a political and economic system that seeks to create a classless society in which the major means of production, such as mines and factories, are owned and controlled by the public."),
     socialism = new ideology(-14,-2,0,8, "Socialism", "Socialism is a range of economic and social systems characterised by social ownership of the means of production and workers' self-management, as well as the political theories and movements associated with them."),
     ...
     centre_left = new ideology(-2,0,-8,8, "Centre-Left", "Centre-left politics are political views that lean to the left-wing political spectrum, but closer to the centre. Those on the centre-left believe in working within the established systems to improve social justice. The centre-left promotes a degree of social equality that it believes is achievable through promoting equal opportunity."),
